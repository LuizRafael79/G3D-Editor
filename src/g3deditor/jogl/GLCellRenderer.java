...
public abstract class GLCellRenderer
{
	...
	private final void updateTexture(final GL2 gl)
	{
		...
		try
		{
			...
			_nsweTexture.enable(gl);
			_nsweTexture.setTexParameteri(gl, GL2.GL_TEXTURE_MIN_FILTER, GL2.GL_LINEAR_MIPMAP_LINEAR);
			_nsweTexture.setTexParameteri(gl, GL2.GL_TEXTURE_MAG_FILTER, GL2.GL_LINEAR_MIPMAP_LINEAR);
		}
		catch (final Exception e)
		{
			_nsweTexture = null;
