...
public final class FrameMain extends JFrame implements ActionListener
{
	...
	private FrameMain()
	{
		super("G3D-Editor [Beta 1.6] by Galagard");
	...
	public final void actionPerformed(final ActionEvent e)
	{
		...
		else if (e.getSource() == _buttonHelp)
		{
			JOptionPane.showMessageDialog(this,
					"<html><b>G3DEditor</b> - By Galagard<br>"
					+ "<b>Original Author</b> Forsaiken aka Patrick Biesenbach<br>" +
					"If you like this program please donate!<br>PayPal/E-Mail: <i>luizramicco@gmail.com</i><br><br>" +
					"Controll:<br><table>" +
					...
					"<i>https://github.com/LuizRafael79/G3DEditor</i>" +
					"</html>", "About", JOptionPane.INFORMATION_MESSAGE);
		}
		else if (e.getSource() == _buttonDonate)
		{
			Util.openBrowser("https://www.paypal.com/donate/?hosted_button_id=JU6TYJWMZQE9N");
		}
	}
}